...
const careers: ICareer[] = [
    ...
    project: [
      {
        ...
        date: '2022-09 ~',
        desc: '투어 입장권 판매 서비스',
        url: ['https://fnd.hanatour.com/'],
        skill: ['Vue', 'Vue/serverer-render', 'Vuex', 'Element-UI', 'Express'],
        performance: ['바우처 사용 기능 추가', '유지 및 보수'],
      },
      {
        title: ['Planner'],
        date: '2022-06 ~',
    ...
    project: [
      {
        ...
        performance: [
          ...
          '실제 API 수준의 Mocking(JSON, lowdb, express)개발 환경 구성(기여도 100%)',
          'Jest 기반의 테스트 작성',
      ...
      },
      {
        ...
        performance: [
          ...
          'Back Office 구현(기여도 80%)',
          'Docker와 GitHub Actions를 이용한 AWS ECS Fargate 배포(기여도 30%)',
        ],
      },
      {
        title: ['대입용'],
  ...
  {
    companyName: '🏢 오피스허브',
    companyUrl: 'https://www.officehub.kr',
    ...
    project: [
      {
        ...
        performance: [
          '엡 기획/퍼블리싱/서비스 런칭(기여도 70%)',
          'Desktop App 채팅 메시지 조회, 조직도 조회 속도 최적화(기여도 100%)',
          'Desktop App 유지보수(기여도 50%)',
        ],
      },
      {
        title: ['그룹웨어'],
        ...
        performance: [
          '전반적인 그룹웨어 서비스 기획, UI 설계/구현(기여도 70%)',
          '반응형 웹 최적화 (기여도 80%)',
...
const skills: ISkill[] = [
  {
    ...
    content: [
      ...
      {
        title: '다양한 브라우저(Chrome, Safari, Firefox)를 지원할 수 있습니다.',
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      {
        title: 'ES6 문법을 활용해 웹 어플리케이션을 개발하는 데 익숙합니다.',
      },
    ],
  },
  {
    ...
    content: [
      {
        title: 'Vue3로 프로젝트 제작 경험이 있습니다.',
        desc: '초기 개발 진행 시 프로젝트 설정에 드는 소요시간을 줄이고자 시작용 템플릿을 별도로 만들어 상시 업데이트를 해주고 있습니다. ',
      },
      {
        title: 'Vuex, Pinia 등의 상태관리 라이브러리를 능숙하게 사용합니다.',
      ...
      {
        title: '렌더링 최적화를 위해 라이프사이클에 맞춰 데이터를 로딩합니다.',
      },
      {
        title:
